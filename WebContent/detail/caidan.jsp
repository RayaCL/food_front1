		...
		<div id="menu">
				...
				<ul>
					...
					<c:forEach var="v" items="${requestScope.foodlist.data}">
						<li>
							<dl>
								<dt>
									<a href="${pageContext.request.contextPath}/CaiXiangxi?foodid=${pageScope.v.FOODID}">
										<img width="214px" height="145px" src="${pageContext.request.contextPath}/ShowImageServlet?imageName=${pageScope.v.IMAGEURL}" />
									</a>
								</dt>
								<dd class="f1">
									<a href="${pageContext.request.contextPath}/CaiXiangxi?foodid=${pageScope.v.FOODID}">${pageScope.v.FOODNAME}</a>
								</dd>
								<dd class="f2">
									<a href="${pageContext.request.contextPath}/CaiXiangxi?foodid=${pageScope.v.FOODID}">&yen;${pageScope.v.PRICE}</a>
								</dd>
							</dl>
						</li>
					</c:forEach>
			...
			<div id="foot">
						...
						<span
							...
							<a href="${pageContext.request.contextPath}/FoodServlet?curPage=${requestScope.foodlist.prePage}">&lt;&lt;</a>
							</span>
				...
				<div id="btn">
					<ul>
						...
						<span style="float:right; line-height:53px; margin-right:10px;  ">
							<a
							href="${pageContext.request.contextPath}/FoodServlet?curPage=${requestScope.foodlist.nextPage}"
