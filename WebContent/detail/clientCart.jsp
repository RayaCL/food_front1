				...
				<table align="center" width="100%">
					<tr height="40">
				 	...
				 	<c:if test="${fn:startsWith(pageScope.ss.key,'cart_') }">
						<tr height="60">
						 		...
						 		<td align="center" width="20%">
						 			<input type="button" value="删除" class="btn_next" lang="3" onclick="window.location='${pageContext.request.contextPath}/FoodCart?flag=delete&cid=${pageScope.ss.key }'" />
						 		</td>
					 	</tr>
					</c:if>
					</c:forEach>
					<tr>
						<td colspan="6" align="right">总计:
							...
							<span style="font-size:36px;">&yen;&nbsp;${sessionScope.zong}</span>
							<label
